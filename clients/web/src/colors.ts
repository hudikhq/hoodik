...
export const colorsBgLight = {
  ...
  lightDark: 'bg-white text-black dark:bg-slate-900/70 dark:text-white',
...
export const getButtonColor = (
  ...
  const colors = {
    ...
    bg: {
      ...
      light: 'bg-gray-100 text-black dark:bg-slate-800 dark:text-white',
    ...
    bgHover: {
      ...
      light: 'hover:bg-gray-200 hover:dark:bg-slate-700',
    ...
    text: {
      white: 'text-white',
      whiteDark: 'text-white dark:text-slate-900',
      light: 'text-gray-100 dark:text-slate-800',
      lightDark: 'text-gray-100 dark:text-slate-800',
    ...
    outlineHover: {
      ...
      whiteDark: 'hover:text-white hover:dark:text-slate-900',
      light: 'hover:text-gray-100 hover:dark:text-slate-800',
      lightDark: 'hover:text-gray-100 hover:dark:text-slate-800',
      contrast:
