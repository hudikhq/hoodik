...
import NumberDynamic from '@/components/ui/NumberDynamic.vue'
import BaseIcon from '@/components/ui/BaseIcon.vue'
import BaseLevel from '@/components/ui/BaseLevel.vue'
import PillTagTrend from '@/components/ui/PillTagTrend.vue'
...
<template>
  <CardBox>
    <BaseLevel v-if="trend" class="mb-3" mobile>
      ...
      <BaseButton :icon="mdiCog" icon-w="w-4" icon-h="h-4" color="light" small />
    </BaseLevel>
    <BaseLevel mobile>
      <div>
