...
<template>
  ...
  >
    <div class="flex items-center justify-between gap-3 mb-4">
      ...
      <button
        type="button"
        class="shrink-0 w-11 h-11 inline-flex items-center justify-center rounded-full text-brownish-400 hover:text-brownish-700 dark:hover:text-brownish-100 hover:bg-paper-100 dark:hover:bg-brownish-800 transition-colors"
