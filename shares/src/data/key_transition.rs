...
/// current one fails. Absent means the signer never rotated — verify against
/// the current key only. Carries only public certificate material; no private
/// or password state is ever included.
